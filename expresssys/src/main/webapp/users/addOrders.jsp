	...
	$.ajax({
		...
		dataType: 'JSON',
	 	success: function( data ){
	 		...
	 		$.get("Admin/goods/find.action",{res1:1,rows:100,page:1},function(datas){
	...
	$.ajax({
		...
		success:function(data,status){
			if(data>0){
				...
				$.post("Admin/goods/update.action",{res1:2,gid:gid},function(data){
				},"json");
