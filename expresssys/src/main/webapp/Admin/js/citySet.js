function SelCity(obj,e,ipuName) {
    var ths = obj;
    ...
    $("#_citys0 a").click(function () {
        ...
        $("#"+ipuName).val($(this).data("name")).css("color","#333");
        $("#sheng").html(lev);
        $("#hproper").remove();
        $("#harea").remove();
        ...
        $("#_citys1 a").click(function () {
            ...
            var bc = $("#hcity").val();
            $("#"+ipuName).val(bc+ "-" + $(this).data("name")).css("color","#333");
            ...
            $("#_citys2 a").click(function () {
                ...
                $("#"+ipuName).val(bc + "-" + bp + "-" + $(this).data("name")).css("color","#333");
                Iput.colse();
            });
