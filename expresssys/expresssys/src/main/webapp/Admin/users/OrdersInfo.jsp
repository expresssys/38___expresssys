...
<div class="ordersInfo-container">
	...
	<div class="search-box">
		<input class="orderInfo-search-btn" value="确认收货" type="button" id="orderInfo-search-sh">
	</div>
...
$("#orderInfo-search-sh").click(function(){
	var osid=$.trim($("#osid").html());
	$.ajax({
   	        url: 'orders/updateStatus.action',
   	        data:{osid:osid,ostatus:0},
   	        type: 'post',
   	        success: function (data){  
   	        	if(data==1){
   	        		alert("确认收货成功");
